...
While the weights and biases in a network can be trained by backpropagation, there are parameter of the network that cannot be trained in 
this way, but still affect the performance of the network. These are hyperparameters and they are set before the training begins. The best 
hyperparameters are then selected by training the model with different combinations and taking the model that performs best on a validation
set.
