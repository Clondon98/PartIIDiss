...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.4\linewidth}
    \centering
    \includegraphics[scale=.5]{figs/rand_noise.pdf}
    \caption{Pixel values selected randomly}
  \end{subfigure}
  \hspace{0.1\textwidth}
  \begin{subfigure}[b]{0.4\linewidth}
    \centering
    \includegraphics[scale=.5]{figs/digit.pdf}
    \caption{MNIST digit}
  \end{subfigure}
...
of these gradients in backpropagation would lead to very small gradients in the lower layers, leading to very slow updating of the weights in 
these layers}
